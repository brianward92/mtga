...
corpus~\citep{seventeenlands}: 31 expansions from STX (April 2021) through
...
CSVs; the oldest era reports match-based rather than game-based skill
...
exclusion); packs are 13, 14, or 15 picks depending on the set (a model
...
from Scryfall are permitted---that is the zero-shot contract: public card
information only, no human behavioral data of any kind.
