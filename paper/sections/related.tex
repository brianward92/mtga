...
quantitative result on it from multi-set feature-based training (a
separate zero-shot LLM number exists, discussed below under ``LLMs as
drafters''). They replace one-hot card identities with
...
their best representation reaches 55.4\% pick agreement. That
