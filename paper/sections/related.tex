...
picks. Zero-shot GPT-4o reaches 43\%, narrowly above the hour-zero
heuristics we measure (\S\ref{sec:results}), and providing full rules text
in the prompt lowers it. Open 7--8B models fail to pick legal cards until
