...
guidelines (bulk S3 downloads; no API scraping). Card metadata is from
Scryfall \citep{scryfall}, used per its API guidelines; Scryfall neither
produces nor endorses this work.

Portions of the materials used are property of Wizards of the Coast.
\copyright{} Wizards of the Coast LLC. This work contains unofficial Fan
Content permitted under the Wizards of the Coast Fan Content Policy; it
is not approved or endorsed by Wizards. \mtg{} and its card names and
text are trademarks and copyrights of Wizards of the Coast. Licensed-IP
card names (including Marvel-universe names in MSH and TMT) appear only
as data strings in sourced fields of the released artifacts and are the
property of their respective owners. No card images are used or
redistributed.
