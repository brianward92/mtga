...
follow throughout: every image is shown full and unmodified, with no
cropping, distorting, blurring, sharpening, desaturating, color-shifting,
or watermarking of the card art itself. Any score or label in a
...
endorses this work. The cards illustrated are drawn from BRO and SOS,
both public, released development sets (\S\ref{sec:data}), never from
