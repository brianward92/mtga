...
embeds every card once per (set, format) step; a set-context tower
summarises the full card list, a pool tower summarises the drafter's
held cards, and a per-candidate scorer combines the candidate embedding
