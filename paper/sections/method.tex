...
We test the set-context tower's contribution directly by removing it and
retraining (we call this variant A-noctx, Table~\ref{tab:ablations},
\S\ref{sec:analysis}). It scores higher on all three dev sets. That
tower-free configuration, not the one just described, is what F-full and
the frozen MSH evaluation actually run. The first invariant still holds
